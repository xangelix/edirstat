...
op-zoom-treemap = Metti a fuoco nel Treemap
...
toast-zoomed-treemap = Treemap focalizzato sulla cartella
...
modal-licenses-tab-deps = Librerie di terze parti
modal-licenses-app-desc = eDirStat è un software open source distribuito con licenza MIT:
modal-licenses-desc = Le seguenti librerie e crate di terze parti sono utilizzate in questa applicazione:
modal-licenses-copy-btn = 📋 Copia licenza
modal-licenses-copy-all-btn = 📋 Copia licenze
...
file-menu-close = Chiudi scansione
file-menu-quit = Esci

badge-dataless-cloud = File cloud / senza dati locali
badge-symlink = Collegamento simbolico
badge-special-file = File speciale (Pipe / Socket / Dispositivo)
badge-permission-denied = Accesso negato
