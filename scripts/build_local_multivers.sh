...
for TARGET in $TARGETS; do
    ...
    echo "==========================================================="
    echo "🚀 Building local multivers binary"
    echo "🎯 Target: $TARGET"
    ...
    rm -rf "$WRAPPER_TMP"
    WRAPPER_TMP=""
    rm -f "${PROJECT_DIR}/multivers_manifest.json" "${PROJECT_DIR}/builds_absolute.json"

    echo "==========================================================="
    echo "✅ Success! cargo-multivers binary built:"
    echo "   $FINAL_EXE"
    echo "==========================================================="
done
